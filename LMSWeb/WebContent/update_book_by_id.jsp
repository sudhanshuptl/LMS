...
<th> <a href="logout.jsp">Logout</a><br/></th>
	...
	<div class="form">
		...
		<div class="tab-content">
			<div id="signup">
				...
				<form action="update_book_by_id.jsp" method="post">
	...
	<%
		if (request.getParameter("bookId") != null) {
			...
			if(databaseServices.validateBookId(Integer.parseInt(bookId))){
				RequestDispatcher requestDispatcher = request.getRequestDispatcher("update_book.jsp");
				requestDispatcher.forward(request, response);
			}else{
				out.print("Not a valid book id");
			}
